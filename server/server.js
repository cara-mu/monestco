...
const db = new sqlite3.Database('./database.db', (err) => {
  if (err) {
      ...
      db.run('CREATE TABLE company( \
          ...
          if (err) {
            ...
            let insert = 'INSERT INTO company (name, industrystandards_id, industry_id, A, B, C, D) VALUES (?,?,?,?,?,?,?)';
            db.run(insert, ["Nike", 1, 1, 1, 1, 1, 1]);
            db.run(insert, ["Adidas", 2, 1, 2, 2, 2, 2]);
            db.run(insert, ["Timberland", 3, 1, 3, 3, 3, 3]);
          }
      });
      ...
      db.run('CREATE TABLE A ( \
          ...
          A11_text NVARCHAR(100) NOT NULL, \
          ...
          if (err) {
            ...
            let insert = 'INSERT INTO A (company_id, A, A1, A11_score, A11_text, A12_score, A12_text, A2, A21_score, A21_text, A22_score, A22_text, A23_score, A23_text, A3, A31_score, A31_text, A32_score, A32_text, A33_score, A33_text, A4, A41_score, A41_text, A42_score, A42_text, A43_score, A43_text) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
            db.run(insert, [1, 20, 40, 50, "a1.1 stuff", 70, "a1.2 stuff", 24, 37, "a2.1 stuff", 83, "a2.2 stuff", 99, "a2.3 stuff", 36, 1, "a3.1 stuff", 62, "a3.2 stuff", 44, "a3.3 stuff", 68, 80, "a4.1 stuff", 5, "a4.2 stuff", 32, "a4.3 stuff"]);
            db.run(insert, [2, 20, 40, 50, "a1.1 stuff", 70, "a1.2 stuff", 24, 37, "a2.1 stuff", 83, "a2.2 stuff", 99, "a2.3 stuff", 36, 1, "a3.1 stuff", 62, "a3.2 stuff", 44, "a3.3 stuff", 68, 80, "a4.1 stuff", 5, "a4.2 stuff", 32, "a4.3 stuff"]);
            db.run(insert, [3, 20, 40, 50, "a1.1 stuff", 70, "a1.2 stuff", 24, 37, "a2.1 stuff", 83, "a2.2 stuff", 99, "a2.3 stuff", 36, 1, "a3.1 stuff", 62, "a3.2 stuff", 44, "a3.3 stuff", 68, 80, "a4.1 stuff", 5, "a4.2 stuff", 32, "a4.3 stuff"]);
          }
      });
      ...
      db.run('CREATE TABLE B ( \
        ...
        if (err) {
          ...
          let insert = 'INSERT INTO B (company_id, B, B1, B11_score, B11_text, B12_score, B12_text, B13_score, B13_text, B2, B21_score, B21_text, B22_score, B22_text, B23_score, B23_text, B3, B31_score, B31_text, B32_score, B32_text, B33_score, B33_text, B34_score, B34_text, B4, B41_score, B41_text, B42_score, B42_text, B43_score, B43_text, B44_score, B44_text, B45_score, B45_text) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
          db.run(insert, [1, 20, 40, 50, "b1.1 stuff", 70, "b1.2 stuff", 24, "b1.3 stuff", 37, 63, "b2.1 stuff", 83, "b2.2 stuff", 99, "b2.3 stuff", 36, 1, "b3.1 stuff", 62, "b3.2 stuff", 44, "b3.3 stuff", 68, "b3.4 stuff", 23, 80, "b4.1 stuff", 5, "b4.2 stuff", 32, "b4.3 stuff", 78, "b4.4 stuff", 13, "b4.5 stuff"]);
          db.run(insert, [2, 20, 40, 50, "b1.1 stuff", 70, "b1.2 stuff", 24, "b1.3 stuff", 37, 63, "b2.1 stuff", 83, "b2.2 stuff", 99, "b2.3 stuff", 36, 1, "b3.1 stuff", 62, "b3.2 stuff", 44, "b3.3 stuff", 68, "b3.4 stuff", 23, 80, "b4.1 stuff", 5, "b4.2 stuff", 32, "b4.3 stuff", 78, "b4.4 stuff", 13, "b4.5 stuff"]);
          db.run(insert, [3, 20, 40, 50, "b1.1 stuff", 70, "b1.2 stuff", 24, "b1.3 stuff", 37, 63, "b2.1 stuff", 83, "b2.2 stuff", 99, "b2.3 stuff", 36, 1, "b3.1 stuff", 62, "b3.2 stuff", 44, "b3.3 stuff", 68, "b3.4 stuff", 23, 80, "b4.1 stuff", 5, "b4.2 stuff", 32, "b4.3 stuff", 78, "b4.4 stuff", 13, "b4.5 stuff"]);
        }
    });
    ...
    db.run('CREATE TABLE C ( \
      ...
      if (err) {
        ...
        let insert = 'INSERT INTO C (company_id, C, C1, C11_score, C11_text, C12_score, C12_text, C13_score, C13_text, C14_score, C14_text, C2, C21_score, C21_text, C22_score, C22_text, C23_score, C23_text, C24_score, C24_text, C3, C31_score, C31_text, C32_score, C32_text, C33_score, C33_text, C34_score, C34_text, C4, C41_score, C41_text, C42_score, C42_text, C43_score, C43_text, C44_score, C44_text) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
        db.run(insert, [1, 20, 40, 50, "c1.1 stuff", 70, "c1.2 stuff", 24, "c1.3 stuff", 37, "c1.4 stuff", 89, 63, "c2.1 stuff", 83, "c2.2 stuff", 99, "c2.3 stuff", 36, "c2.4 stuff", 43, 1, "c3.1 stuff", 62, "c3.2 stuff", 44, "c3.3 stuff", 68, "c3.4 stuff", 23, 80, "c4.1 stuff", 5, "c4.2 stuff", 32, "c4.3 stuff", 78, "c4.4 stuff"]);
        db.run(insert, [2, 20, 40, 50, "c1.1 stuff", 70, "c1.2 stuff", 24, "c1.3 stuff", 37, "c1.4 stuff", 89, 63, "c2.1 stuff", 83, "c2.2 stuff", 99, "c2.3 stuff", 36, "c2.4 stuff", 43, 1, "c3.1 stuff", 62, "c3.2 stuff", 44, "c3.3 stuff", 68, "c3.4 stuff", 23, 80, "c4.1 stuff", 5, "c4.2 stuff", 32, "c4.3 stuff", 78, "c4.4 stuff"]);
        db.run(insert, [3, 20, 40, 50, "c1.1 stuff", 70, "c1.2 stuff", 24, "c1.3 stuff", 37, "c1.4 stuff", 89, 63, "c2.1 stuff", 83, "c2.2 stuff", 99, "c2.3 stuff", 36, "c2.4 stuff", 43, 1, "c3.1 stuff", 62, "c3.2 stuff", 44, "c3.3 stuff", 68, "c3.4 stuff", 23, 80, "c4.1 stuff", 5, "c4.2 stuff", 32, "c4.3 stuff", 78, "c4.4 stuff"]);
      }
  });
  ...
  db.run('CREATE TABLE D ( \
    ...
    if (err) {
      ...
      let insert = 'INSERT INTO D (company_id, D, D1, D11_score, D11_text, D12_score, D12_text, D2, D21_score, D21_text, D22_score, D22_text, D23_score, D23_text, D3, D31_score, D31_text, D32_score, D32_text, D33_score, D33_text, D34_score, D34_text, D35_score, D35_text) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
      db.run(insert, [1, 20, 40, 50, "d1.1 stuff", 70, "d1.2 stuff", 24, 50, "d2.1 stuff", 83, "d2.2 stuff", 99, "d2.3 stuff", 36, 50, "c3.1 stuff", 62, "c3.2 stuff", 44, "c3.3 stuff", 68, "c3.4 stuff", 78, "c3.5 stuff"]);
      db.run(insert, [2, 20, 40, 50, "d1.1 stuff", 70, "d1.2 stuff", 24, 50, "d2.1 stuff", 83, "d2.2 stuff", 99, "d2.3 stuff", 36, 50, "c3.1 stuff", 62, "c3.2 stuff", 44, "c3.3 stuff", 68, "c3.4 stuff", 78, "c3.5 stuff"]);
      db.run(insert, [3, 20, 40, 50, "d1.1 stuff", 70, "d1.2 stuff", 24, 50, "d2.1 stuff", 83, "d2.2 stuff", 99, "d2.3 stuff", 36, 50, "c3.1 stuff", 62, "c3.2 stuff", 44, "c3.3 stuff", 68, "c3.4 stuff", 78, "c3.5 stuff"]);
    }
});
