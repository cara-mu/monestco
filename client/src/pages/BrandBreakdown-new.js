    ...
    <div className="popup">
      <div className="popup-content">
        ...
        >
          ...
          <div>
            <i>{item.citations[i].title[k]}</i>
            {item.citations[i].restofcit[k].substring(
              item.citations[i].restofcit[k].length,
              item.citations[i].restofcit[k].length - 4
            ) != "null"
              ? ", " + item.citations[i].restofcit[k]
              : ", " +
                item.citations[i].restofcit[k].substring(
                  0,
                  item.citations[i].restofcit[k].length - 6
                )}
          </div>
        </div>
    ...
    return item.scores.map((score, i) => {
      return (
        <div className="breakdown_nestedField">
          ...
          <div className="breakdown_nestedField-score">
            {score}/{item.total[i]}
          </div>
              ...
              item.citations[i].title.map((title, k) => {
                ...
                return (
                  <span>
                    ...
                    <span className="breakdown_citation-hover">
                      <i>{item.citations[i].title[k]}</i>
                      {item.citations[i].restofcit[k].substring(
                        item.citations[i].restofcit[k].length,
                        item.citations[i].restofcit[k].length - 4
    ...
    return item.scores.map((score, i) => {
      return (
        <div
          className={
            showInfo == i
              ? "breakdown_nestedField selected"
              : "breakdown_nestedField"
          }
        >
          {showInfo == i ? (
            <div>
              ...
              {item.citations[i].title.map((title, k) => {
                return (
                  <span>
                    ...
                    {showPopup == k && (
                      <Popup item={item} i={i} k={k} closePopup={closePopup} />
                    )}
                  </span>
                );
              })}
  ...
  return (
    <div className="breakdown_subField">
      ...
      >
        ...
        <div className="breakdown_subField-score">
          {item.mainNestedScore}/{item.total}
        </div>
        <ExpandMoreSharpIcon
          //   onClick={() => {
          //     if (showNested === indexKey) {
          ...
          className={
            show && showNested == indexKey
              ? "circle-breakdown-close"
              : "circle-breakdown fill-white"
          }
        />
      </div>
      <div
        className={`animate-field ${
          show && showNested == indexKey ? "animate" : ""
        }`}
      >
        {show &&
          showNested == indexKey &&
...
const Mainfield = ({
  ...
  const [show, setShow] = useState(
    window.innerWidth < 600 ? false : index === 0 ? true : false
  );
  ...
  return (
    <div className="breakdown_mainField">
      ...
      <div
        className={`animate-field ${
          show && showSubField === indexKey ? "animate" : ""
        }`}
      >
        {show &&
          ...
          item.subfield.map((item, index) => {
            return (
              <Subfield
                ...
                setShowNested={(key) => setShowNested(key)}
              />
            );
          })}
      </div>
  ...
  componentDidMount() {
      ...
      .then((resp) => {
        ...
        for (var i = 0; i < resp.data.length; i++) {
          if (resp.data[i].Type == "A1.1") {
            ...
            arrA11_2.push(
              resp.data[i]["PublishingGroup"] +
                ", " +
                resp.data[i]["Date"] +
                ", " +
                resp.data[i]["Pages"]
            );
            field[0].subfield[0].subNestedField[0].citations[0] = {
              title: arrA11,
              restofcit: arrA11_2,
            };
          }
          if (resp.data[i].Type == "A1.2") {
            ...
            field[0].subfield[0].subNestedField[0].citations[1] = {
              title: arrA12,
              restofcit: arrA12_2,
            };
          }
          if (resp.data[i].Type == "A2.1") {
            ...
            field[0].subfield[1].subNestedField[0].citations[0] = {
              title: arrA21,
              restofcit: arrA21_2,
            };
          }
          if (resp.data[i].Type == "A2.2") {
            ...
            field[0].subfield[1].subNestedField[0].citations[1] = {
              title: arrA22,
              restofcit: arrA22_2,
            };
          }
          if (resp.data[i].Type == "A2.3") {
            ...
            field[0].subfield[1].subNestedField[0].citations[2] = {
              title: arrA23,
              restofcit: arrA23_2,
            };
          }
          if (resp.data[i].Type == "A3.1") {
            ...
            field[0].subfield[2].subNestedField[0].citations[0] = {
              title: arrA31,
              restofcit: arrA31_2,
            };
          }
          if (resp.data[i].Type == "A3.2") {
            ...
            field[0].subfield[2].subNestedField[0].citations[1] = {
              title: arrA32,
              restofcit: arrA32_2,
            };
          }
          if (resp.data[i].Type == "A3.3") {
            ...
            field[0].subfield[2].subNestedField[0].citations[2] = {
              title: arrA33,
              restofcit: arrA33_2,
            };
          }
          if (resp.data[i].Type == "A4.1") {
            ...
            field[0].subfield[3].subNestedField[0].citations[0] = {
              title: arrA41,
              restofcit: arrA41_2,
            };
          }
          if (resp.data[i].Type == "A4.2") {
            ...
            field[0].subfield[3].subNestedField[0].citations[1] = {
              title: arrA42,
              restofcit: arrA42_2,
            };
          }
          if (resp.data[i].Type == "A4.3") {
            ...
            field[0].subfield[3].subNestedField[0].citations[2] = {
              title: arrA43,
              restofcit: arrA43_2,
            };
          }
          if (resp.data[i].Type == "B1.1") {
            ...
            field[1].subfield[0].subNestedField[0].citations[0] = {
              title: arrB11,
              restofcit: arrB11_2,
            };
          }
          if (resp.data[i].Type == "B1.2") {
            ...
            field[1].subfield[0].subNestedField[0].citations[1] = {
              title: arrB12,
              restofcit: arrB12_2,
            };
          }
          if (resp.data[i].Type == "B1.3") {
            ...
            field[1].subfield[0].subNestedField[0].citations[2] = {
              title: arrB13,
              restofcit: arrB13_2,
            };
          }
          if (resp.data[i].Type == "B2.1") {
            ...
            field[1].subfield[1].subNestedField[0].citations[0] = {
              title: arrB21,
              restofcit: arrB21_2,
            };
          }
          if (resp.data[i].Type == "B2.2") {
            ...
            field[1].subfield[1].subNestedField[0].citations[1] = {
              title: arrB22,
              restofcit: arrB22_2,
            };
          }
          if (resp.data[i].Type == "B2.3") {
            ...
            field[1].subfield[1].subNestedField[0].citations[2] = {
              title: arrB23,
              restofcit: arrB23_2,
            };
          }
          if (resp.data[i].Type == "B3.1") {
            ...
            field[1].subfield[2].subNestedField[0].citations[0] = {
              title: arrB31,
              restofcit: arrB31_2,
            };
          }
          if (resp.data[i].Type == "B3.2") {
            ...
            field[1].subfield[2].subNestedField[0].citations[1] = {
              title: arrB32,
              restofcit: arrB32_2,
            };
          }
          if (resp.data[i].Type == "B3.3") {
            ...
            field[1].subfield[2].subNestedField[0].citations[2] = {
              title: arrB33,
              restofcit: arrB33_2,
            };
          }
          if (resp.data[i].Type == "B3.4") {
            ...
            field[1].subfield[2].subNestedField[0].citations[3] = {
              title: arrB34,
              restofcit: arrB34_2,
            };
          }
          if (resp.data[i].Type == "B4.1") {
            ...
            field[1].subfield[3].subNestedField[0].citations[0] = {
              title: arrB41,
              restofcit: arrB41_2,
            };
          }
          if (resp.data[i].Type == "B4.2") {
            ...
            field[1].subfield[3].subNestedField[0].citations[1] = {
              title: arrB42,
              restofcit: arrB42_2,
            };
          }
          if (resp.data[i].Type == "B4.3") {
            ...
            field[1].subfield[3].subNestedField[0].citations[2] = {
              title: arrB43,
              restofcit: arrB43_2,
            };
          }
          if (resp.data[i].Type == "B4.4") {
            ...
            field[1].subfield[3].subNestedField[0].citations[3] = {
              title: arrB44,
              restofcit: arrB44_2,
            };
          }
          ...
          if (resp.data[i].Type == "C1.1") {
            ...
            field[2].subfield[0].subNestedField[0].citations[0] = {
              title: arrC11,
              restofcit: arrC11_2,
            };
          }
          if (resp.data[i].Type == "C1.2") {
            ...
            field[2].subfield[0].subNestedField[0].citations[1] = {
              title: arrC12,
              restofcit: arrC12_2,
            };
          }
          if (resp.data[i].Type == "C1.3") {
            ...
            field[2].subfield[0].subNestedField[0].citations[2] = {
              title: arrC13,
              restofcit: arrC13_2,
            };
          }
          if (resp.data[i].Type == "C1.4") {
            ...
            field[2].subfield[0].subNestedField[0].citations[3] = {
              title: arrC14,
              restofcit: arrC14_2,
            };
          }
          if (resp.data[i].Type == "C2.1") {
            ...
            field[2].subfield[1].subNestedField[0].citations[0] = {
              title: arrC21,
              restofcit: arrC21_2,
            };
          }
          if (resp.data[i].Type == "C2.2") {
            ...
            field[2].subfield[1].subNestedField[0].citations[1] = {
              title: arrC22,
              restofcit: arrC22_2,
            };
          }
          if (resp.data[i].Type == "C2.3") {
            ...
            field[2].subfield[1].subNestedField[0].citations[2] = {
              title: arrC23,
              restofcit: arrC23_2,
            };
          }
          if (resp.data[i].Type == "C2.4") {
            ...
            field[2].subfield[1].subNestedField[0].citations[3] = {
              title: arrC24,
              restofcit: arrC24_2,
            };
          }
          if (resp.data[i].Type == "C3.1") {
            ...
            field[2].subfield[2].subNestedField[0].citations[0] = {
              title: arrC31,
              restofcit: arrC31_2,
            };
          }
          if (resp.data[i].Type == "C3.2") {
            ...
            field[2].subfield[2].subNestedField[0].citations[1] = {
              title: arrC32,
              restofcit: arrC32_2,
            };
          }
          if (resp.data[i].Type == "C3.3") {
            ...
            field[2].subfield[2].subNestedField[0].citations[2] = {
              title: arrC33,
              restofcit: arrC33_2,
            };
          }
          if (resp.data[i].Type == "C3.4") {
            ...
            field[2].subfield[2].subNestedField[0].citations[3] = {
              title: arrC34,
              restofcit: arrC34_2,
            };
          }
          if (resp.data[i].Type == "C4.1") {
            ...
            field[2].subfield[3].subNestedField[0].citations[0] = {
              title: arrC41,
              restofcit: arrC41_2,
            };
          }
          if (resp.data[i].Type == "C4.2") {
            ...
            field[2].subfield[3].subNestedField[0].citations[1] = {
              title: arrC42,
              restofcit: arrC42_2,
            };
          }
          if (resp.data[i].Type == "C4.3") {
            ...
            field[2].subfield[3].subNestedField[0].citations[2] = {
              title: arrC43,
              restofcit: arrC43_2,
            };
          }
          if (resp.data[i].Type == "C4.4") {
            ...
            field[2].subfield[3].subNestedField[0].citations[3] = {
              title: arrC44,
              restofcit: arrC44_2,
            };
          }
          if (resp.data[i].Type == "D1.1") {
            ...
            field[3].subfield[0].subNestedField[0].citations[0] = {
              title: arrD11,
              restofcit: arrD11_2,
            };
          }
          if (resp.data[i].Type == "D1.2") {
            ...
            field[3].subfield[0].subNestedField[0].citations[1] = {
              title: arrD12,
              restofcit: arrD12_2,
            };
          }
          if (resp.data[i].Type == "D2.1") {
            ...
            field[3].subfield[1].subNestedField[0].citations[0] = {
              title: arrD21,
              restofcit: arrD21_2,
            };
          }
          if (resp.data[i].Type == "D2.2") {
            ...
            field[3].subfield[1].subNestedField[0].citations[1] = {
              title: arrD22,
              restofcit: arrD22_2,
            };
          }
          if (resp.data[i].Type == "D2.3") {
            ...
            field[3].subfield[1].subNestedField[0].citations[2] = {
              title: arrD23,
              restofcit: arrD23_2,
            };
          }
          if (resp.data[i].Type == "D3.1") {
            ...
            field[3].subfield[2].subNestedField[0].citations[0] = {
              title: arrD31,
              restofcit: arrD31_2,
            };
          }
          if (resp.data[i].Type == "D3.2") {
            ...
            field[3].subfield[2].subNestedField[0].citations[1] = {
              title: arrD32,
              restofcit: arrD32_2,
            };
          }
          if (resp.data[i].Type == "D3.3") {
            ...
            field[3].subfield[2].subNestedField[0].citations[2] = {
              title: arrD33,
              restofcit: arrD33_2,
            };
          }
          if (resp.data[i].Type == "D3.4") {
            ...
            field[3].subfield[2].subNestedField[0].citations[3] = {
              title: arrD34,
              restofcit: arrD34_2,
            };
          }
          if (resp.data[i].Type == "D3.5") {
            ...
            field[3].subfield[2].subNestedField[0].citations[4] = {
              title: arrD35,
              restofcit: arrD35_2,
            };
          }
    ...
    axios
      ...
      .then((resp) => {
        ...
        field[0].subfield[0].subNestedField[0].scores[0] =
          resp.data[0]["A1.1score"];
        field[0].subfield[0].subNestedField[0].scores[1] =
          resp.data[0]["A1.2score"];
        field[0].subfield[0].subNestedField[0].texts[0] =
          resp.data[0]["A1.1long"];
        field[0].subfield[0].subNestedField[0].texts[1] =
          resp.data[0]["A1.2long"];

        field[0].subfield[1].subNestedField[0].scores[0] =
          resp.data[0]["A2.1score"];
        field[0].subfield[1].subNestedField[0].scores[1] =
          resp.data[0]["A2.2score"];
        field[0].subfield[1].subNestedField[0].scores[2] =
          resp.data[0]["A2.3score"];
        field[0].subfield[1].subNestedField[0].texts[0] =
          resp.data[0]["A2.1long"];
        field[0].subfield[1].subNestedField[0].texts[1] =
          resp.data[0]["A2.2long"];
        field[0].subfield[1].subNestedField[0].texts[2] =
          resp.data[0]["A2.3long"];

        field[0].subfield[2].subNestedField[0].scores[0] =
          resp.data[0]["A3.1score"];
        field[0].subfield[2].subNestedField[0].scores[1] =
          resp.data[0]["A3.2score"];
        field[0].subfield[2].subNestedField[0].scores[2] =
          resp.data[0]["A3.3score"];
        field[0].subfield[2].subNestedField[0].texts[0] =
          resp.data[0]["A3.1long"];
        field[0].subfield[2].subNestedField[0].texts[1] =
          resp.data[0]["A3.2long"];
        field[0].subfield[2].subNestedField[0].texts[2] =
          resp.data[0]["A3.3long"];

        field[0].subfield[3].subNestedField[0].scores[0] =
          resp.data[0]["A4.1score"];
        field[0].subfield[3].subNestedField[0].scores[1] =
          resp.data[0]["A4.2score"];
        field[0].subfield[3].subNestedField[0].scores[2] =
          resp.data[0]["A4.3score"];
        field[0].subfield[3].subNestedField[0].texts[0] =
          resp.data[0]["A4.1long"];
        field[0].subfield[3].subNestedField[0].texts[1] =
          resp.data[0]["A4.2long"];
        field[0].subfield[3].subNestedField[0].texts[2] =
          resp.data[0]["A4.3long"];
        ...
        field[1].subfield[0].subNestedField[0].scores[0] =
          resp.data[0]["B1.1score"];
        field[1].subfield[0].subNestedField[0].scores[1] =
          resp.data[0]["B1.2score"];
        field[1].subfield[0].subNestedField[0].scores[2] =
          resp.data[0]["B1.3score"];
        field[1].subfield[0].subNestedField[0].texts[0] =
          resp.data[0]["B1.1long"];
        field[1].subfield[0].subNestedField[0].texts[1] =
          resp.data[0]["B1.2long"];
        field[1].subfield[0].subNestedField[0].texts[2] =
          resp.data[0]["B1.3long"];

        field[1].subfield[1].subNestedField[0].scores[0] =
          resp.data[0]["B2.1score"];
        field[1].subfield[1].subNestedField[0].scores[1] =
          resp.data[0]["B2.2score"];
        field[1].subfield[1].subNestedField[0].scores[2] =
          resp.data[0]["B2.3score"];
        field[1].subfield[1].subNestedField[0].texts[0] =
          resp.data[0]["B2.1long"];
        field[1].subfield[1].subNestedField[0].texts[1] =
          resp.data[0]["B2.2long"];
        field[1].subfield[1].subNestedField[0].texts[2] =
          resp.data[0]["B2.3long"];

        field[1].subfield[2].subNestedField[0].scores[0] =
          resp.data[0]["B3.1score"];
        field[1].subfield[2].subNestedField[0].scores[1] =
          resp.data[0]["B3.2score"];
        field[1].subfield[2].subNestedField[0].scores[2] =
          resp.data[0]["B3.3score"];
        field[1].subfield[2].subNestedField[0].scores[3] =
          resp.data[0]["B3.4score"];
        field[1].subfield[2].subNestedField[0].texts[0] =
          resp.data[0]["B3.1long"];
        field[1].subfield[2].subNestedField[0].texts[1] =
          resp.data[0]["B3.2long"];
        field[1].subfield[2].subNestedField[0].texts[2] =
          resp.data[0]["B3.3long"];
        field[1].subfield[2].subNestedField[0].texts[3] =
          resp.data[0]["B3.4long"];

        field[1].subfield[3].subNestedField[0].scores[0] =
          resp.data[0]["B4.1score"];
        field[1].subfield[3].subNestedField[0].scores[1] =
          resp.data[0]["B4.2score"];
        field[1].subfield[3].subNestedField[0].scores[2] =
          resp.data[0]["B4.3score"];
        field[1].subfield[3].subNestedField[0].scores[3] =
          resp.data[0]["B4.4score"];
        field[1].subfield[3].subNestedField[0].texts[0] =
          resp.data[0]["B4.1long"];
        field[1].subfield[3].subNestedField[0].texts[1] =
          resp.data[0]["B4.2long"];
        field[1].subfield[3].subNestedField[0].texts[2] =
          resp.data[0]["B4.3long"];
        field[1].subfield[3].subNestedField[0].texts[3] =
          resp.data[0]["B4.4long"];
        ...
        field[2].subfield[0].subNestedField[0].scores[0] =
          resp.data[0]["C1.1score"];
        field[2].subfield[0].subNestedField[0].scores[1] =
          resp.data[0]["C1.2score"];
        field[2].subfield[0].subNestedField[0].scores[2] =
          resp.data[0]["C1.3score"];
        field[2].subfield[0].subNestedField[0].scores[3] =
          resp.data[0]["C1.4score"];
        field[2].subfield[0].subNestedField[0].texts[0] =
          resp.data[0]["C1.1long"];
        field[2].subfield[0].subNestedField[0].texts[1] =
          resp.data[0]["C1.2long"];
        field[2].subfield[0].subNestedField[0].texts[2] =
          resp.data[0]["C1.3long"];
        field[2].subfield[0].subNestedField[0].texts[3] =
          resp.data[0]["C1.4long"];

        field[2].subfield[1].subNestedField[0].scores[0] =
          resp.data[0]["C2.1score"];
        field[2].subfield[1].subNestedField[0].scores[1] =
          resp.data[0]["C2.2score"];
        field[2].subfield[1].subNestedField[0].scores[2] =
          resp.data[0]["C2.3score"];
        field[2].subfield[1].subNestedField[0].scores[3] =
          resp.data[0]["C2.4score"];
        field[2].subfield[1].subNestedField[0].texts[0] =
          resp.data[0]["C2.1long"];
        field[2].subfield[1].subNestedField[0].texts[1] =
          resp.data[0]["C2.2long"];
        field[2].subfield[1].subNestedField[0].texts[2] =
          resp.data[0]["C2.3long"];
        field[2].subfield[1].subNestedField[0].texts[3] =
          resp.data[0]["C2.4long"];

        field[2].subfield[2].subNestedField[0].scores[0] =
          resp.data[0]["C3.1score"];
        field[2].subfield[2].subNestedField[0].scores[1] =
          resp.data[0]["C3.2score"];
        field[2].subfield[2].subNestedField[0].scores[2] =
          resp.data[0]["C3.3score"];
        field[2].subfield[2].subNestedField[0].scores[3] =
          resp.data[0]["C3.4score"];
        field[2].subfield[2].subNestedField[0].texts[0] =
          resp.data[0]["C3.1long"];
        field[2].subfield[2].subNestedField[0].texts[1] =
          resp.data[0]["C3.2long"];
        field[2].subfield[2].subNestedField[0].texts[2] =
          resp.data[0]["C3.3long"];
        field[2].subfield[2].subNestedField[0].texts[3] =
          resp.data[0]["C3.4long"];

        field[2].subfield[3].subNestedField[0].scores[0] =
          resp.data[0]["C4.1score"];
        field[2].subfield[3].subNestedField[0].scores[1] =
          resp.data[0]["C4.2score"];
        field[2].subfield[3].subNestedField[0].scores[2] =
          resp.data[0]["C4.3score"];
        field[2].subfield[3].subNestedField[0].scores[3] =
          resp.data[0]["C4.4score"];
        field[2].subfield[3].subNestedField[0].texts[0] =
          resp.data[0]["C4.1long"];
        field[2].subfield[3].subNestedField[0].texts[1] =
          resp.data[0]["C4.2long"];
        field[2].subfield[3].subNestedField[0].texts[2] =
          resp.data[0]["C4.3long"];
        field[2].subfield[3].subNestedField[0].texts[3] =
          resp.data[0]["C4.4long"];
        ...
        field[3].subfield[0].subNestedField[0].scores[0] =
          resp.data[0]["D1.1score"];
        field[3].subfield[0].subNestedField[0].scores[1] =
          resp.data[0]["D1.2score"];
        field[3].subfield[0].subNestedField[0].texts[0] =
          resp.data[0]["D1.1long"];
        field[3].subfield[0].subNestedField[0].texts[1] =
          resp.data[0]["D1.2long"];

        field[3].subfield[1].subNestedField[0].scores[0] =
          resp.data[0]["D2.1score"];
        field[3].subfield[1].subNestedField[0].scores[1] =
          resp.data[0]["D2.2score"];
        field[3].subfield[1].subNestedField[0].scores[2] =
          resp.data[0]["D2.3score"];
        field[3].subfield[1].subNestedField[0].texts[0] =
          resp.data[0]["D2.1long"];
        field[3].subfield[1].subNestedField[0].texts[1] =
          resp.data[0]["D2.2long"];
        field[3].subfield[1].subNestedField[0].texts[2] =
          resp.data[0]["D2.3long"];

        field[3].subfield[2].subNestedField[0].scores[0] =
          resp.data[0]["D3.1score"];
        field[3].subfield[2].subNestedField[0].scores[1] =
          resp.data[0]["D3.2score"];
        field[3].subfield[2].subNestedField[0].scores[2] =
          resp.data[0]["D3.3score"];
        field[3].subfield[2].subNestedField[0].scores[3] =
          resp.data[0]["D3.4score"];
        field[3].subfield[2].subNestedField[0].scores[4] =
          resp.data[0]["D3.5score"];
        field[3].subfield[2].subNestedField[0].texts[0] =
          resp.data[0]["D3.1long"];
        field[3].subfield[2].subNestedField[0].texts[1] =
          resp.data[0]["D3.2long"];
        field[3].subfield[2].subNestedField[0].texts[2] =
          resp.data[0]["D3.3long"];
        field[3].subfield[2].subNestedField[0].texts[3] =
          resp.data[0]["D3.4long"];
        field[3].subfield[2].subNestedField[0].texts[4] =
          resp.data[0]["D3.5long"];
    ...
    axios.get("/industry", {}, {}).then((resp) => {
      ...
      field[0].subfield[0].subNestedField[0].total[0] =
        resp.data.rows[0]["A1.1total"];
      field[0].subfield[0].subNestedField[0].total[1] =
        resp.data.rows[0]["A1.2total"];

      field[0].subfield[1].total = resp.data.rows[0]["A2total"];
      field[0].subfield[1].subNestedField[0].total[0] =
        resp.data.rows[0]["A2.1total"];
      field[0].subfield[1].subNestedField[0].total[1] =
        resp.data.rows[0]["A2.2total"];
      field[0].subfield[1].subNestedField[0].total[2] =
        resp.data.rows[0]["A2.3total"];

      field[0].subfield[2].total = resp.data.rows[0]["A3total"];
      field[0].subfield[2].subNestedField[0].total[0] =
        resp.data.rows[0]["A3.1total"];
      field[0].subfield[2].subNestedField[0].total[1] =
        resp.data.rows[0]["A3.2total"];
      field[0].subfield[2].subNestedField[0].total[2] =
        resp.data.rows[0]["A3.3total"];

      field[0].subfield[3].total = resp.data.rows[0]["A4total"];
      field[0].subfield[3].subNestedField[0].total[0] =
        resp.data.rows[0]["A4.1total"];
      field[0].subfield[3].subNestedField[0].total[1] =
        resp.data.rows[0]["A4.2total"];
      field[0].subfield[3].subNestedField[0].total[2] =
        resp.data.rows[0]["A4.3total"];

      field[1].subfield[0].total = resp.data.rows[0]["B1total"];
      field[1].subfield[0].subNestedField[0].total[0] =
        resp.data.rows[0]["B1.1total"];
      field[1].subfield[0].subNestedField[0].total[1] =
        resp.data.rows[0]["B1.2total"];
      field[1].subfield[0].subNestedField[0].total[2] =
        resp.data.rows[0]["B1.3total"];

      field[1].subfield[1].total = resp.data.rows[0]["B2total"];
      field[1].subfield[1].subNestedField[0].total[0] =
        resp.data.rows[0]["B2.1total"];
      field[1].subfield[1].subNestedField[0].total[1] =
        resp.data.rows[0]["B2.2total"];
      field[1].subfield[1].subNestedField[0].total[2] =
        resp.data.rows[0]["B2.3total"];

      field[1].subfield[2].total = resp.data.rows[0]["B3total"];
      field[1].subfield[2].subNestedField[0].total[0] =
        resp.data.rows[0]["B3.1total"];
      field[1].subfield[2].subNestedField[0].total[1] =
        resp.data.rows[0]["B3.2total"];
      field[1].subfield[2].subNestedField[0].total[2] =
        resp.data.rows[0]["B3.3total"];
      field[1].subfield[2].subNestedField[0].total[3] =
        resp.data.rows[0]["B3.4total"];

      field[1].subfield[3].total = resp.data.rows[0]["B4total"];
      field[1].subfield[3].subNestedField[0].total[0] =
        resp.data.rows[0]["B4.1total"];
      field[1].subfield[3].subNestedField[0].total[1] =
        resp.data.rows[0]["B4.2total"];
      field[1].subfield[3].subNestedField[0].total[2] =
        resp.data.rows[0]["B4.3total"];
      field[1].subfield[3].subNestedField[0].total[3] =
        resp.data.rows[0]["B4.4total"];

      field[2].subfield[0].total = resp.data.rows[0]["C1total"];
      field[2].subfield[0].subNestedField[0].total[0] =
        resp.data.rows[0]["C1.1total"];
      field[2].subfield[0].subNestedField[0].total[1] =
        resp.data.rows[0]["C1.2total"];
      field[2].subfield[0].subNestedField[0].total[2] =
        resp.data.rows[0]["C1.3total"];
      field[2].subfield[0].subNestedField[0].total[3] =
        resp.data.rows[0]["C1.4total"];

      field[2].subfield[1].total = resp.data.rows[0]["C2total"];
      field[2].subfield[1].subNestedField[0].total[0] =
        resp.data.rows[0]["C2.1total"];
      field[2].subfield[1].subNestedField[0].total[1] =
        resp.data.rows[0]["C2.2total"];
      field[2].subfield[1].subNestedField[0].total[2] =
        resp.data.rows[0]["C2.3total"];
      field[2].subfield[1].subNestedField[0].total[3] =
        resp.data.rows[0]["C2.4total"];

      field[2].subfield[2].total = resp.data.rows[0]["C3total"];
      field[2].subfield[2].subNestedField[0].total[0] =
        resp.data.rows[0]["C3.1total"];
      field[2].subfield[2].subNestedField[0].total[1] =
        resp.data.rows[0]["C3.2total"];
      field[2].subfield[2].subNestedField[0].total[2] =
        resp.data.rows[0]["C3.3total"];
      field[2].subfield[2].subNestedField[0].total[3] =
        resp.data.rows[0]["C3.4total"];

      field[2].subfield[3].total = resp.data.rows[0]["C4total"];
      field[2].subfield[3].subNestedField[0].total[0] =
        resp.data.rows[0]["C4.1total"];
      field[2].subfield[3].subNestedField[0].total[1] =
        resp.data.rows[0]["C4.2total"];
      field[2].subfield[3].subNestedField[0].total[2] =
        resp.data.rows[0]["C4.3total"];
      field[2].subfield[3].subNestedField[0].total[3] =
        resp.data.rows[0]["C4.4total"];

      field[3].subfield[0].total = resp.data.rows[0]["D1total"];
      field[3].subfield[0].subNestedField[0].total[0] =
        resp.data.rows[0]["D1.1total"];
      field[3].subfield[0].subNestedField[0].total[1] =
        resp.data.rows[0]["D1.2total"];

      field[3].subfield[1].total = resp.data.rows[0]["D2total"];
      field[3].subfield[1].subNestedField[0].total[0] =
        resp.data.rows[0]["D2.1total"];
      field[3].subfield[1].subNestedField[0].total[1] =
        resp.data.rows[0]["D2.2total"];
      field[3].subfield[1].subNestedField[0].total[2] =
        resp.data.rows[0]["D2.3total"];

      field[3].subfield[2].total = resp.data.rows[0]["D3total"];
      field[3].subfield[2].subNestedField[0].total[0] =
        resp.data.rows[0]["D3.1total"];
      field[3].subfield[2].subNestedField[0].total[1] =
        resp.data.rows[0]["D3.2total"];
      field[3].subfield[2].subNestedField[0].total[2] =
        resp.data.rows[0]["D3.3total"];
      field[3].subfield[2].subNestedField[0].total[3] =
        resp.data.rows[0]["D3.4total"];
      field[3].subfield[2].subNestedField[0].total[4] =
        resp.data.rows[0]["D3.5total"];
      console.log(field);
      this.setState({ reset: true });
    });
      ...
      <div className="breakdown_container">
        <div className="breakdown_logo">
          ...
          <p className="breakdown_logoText">
            {Math.round(this.state.totalscore, 2)}
            <span style={{ fontSize: 32 }}>/100</span>
          </p>
        </div>
        {this.state.subsidiary != null && (
          <div className="breakdown_info-container">
            <InfoIcon
              style={{ fontSize: "15px", fill: "#3D3E3F", marginRight: "4px" }}
            />
            <span className="breakdown_info-container-text">
              As the parent company, {this.state.subsidiary} manages and
              oversees {this.state.companyName}.
            </span>
          </div>
        )}
        <div className="breakdown_data-container">
          {field.map((item, index) => (
            <Mainfield
              key={index}
              indexKey={index}
              showSubField={this.state.showSubField}
              setShowSubField={this.setShowSubField}
              item={item}
              index={index}
            />
          ))}
