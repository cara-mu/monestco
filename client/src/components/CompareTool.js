...
class CompareTool extends React.Component {
    ...
    async returnIndustryStandards(company, condition) {
        await axios.get(`/api/v1/scores?company=${company}&type=A`,
            ).then(resp => {
        ...
        await axios.get(`/api/v1/scores?company=${company}&type=B`)
            .then(resp => {
                var B1 = {};
        ...
        await axios.get(`/api/v1/scores?company=${company}&type=C`)
            .then(resp => {
                var C1 = {};
        ...
        await axios.get(`/api/v1/scores?company=${company}&type=D`)
            .then(resp => {
                var D1 = {};
